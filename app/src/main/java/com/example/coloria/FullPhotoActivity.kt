...
import com.example.coloria.colorPicker.ColorUtils
...
class FullPhotoActivity : AppCompatActivity() {
    ...
    private fun setInit() {
        ...
        fp_pointer = binding.fpPointer
        fp_cardColor = binding.fpCardColor
        fp_card_color_preview = binding.fpCardColorPreview
        fp_colorHex = binding.fpColorHex
        fp_colorName = binding.fpColorName
        fp_card_colorName = binding.fpCardColorName
